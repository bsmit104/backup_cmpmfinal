class Level3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON('lab3', 'lab3.json');
        // tiles in spritesheet 
        this.load.spritesheet('tileset2', 'tileset2.png', { frameWidth: 16, frameHeight: 16 });
    ...
    create() {
        ...
        var groundTiles = map.addTilesetImage('tileset2');
        // create the ground layer
        wallLayer = map.createLayer('Wall', groundTiles, 0, 0).setScale(4);
